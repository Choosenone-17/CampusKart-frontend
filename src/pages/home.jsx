      ...
      <section id="products" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Left Promo */}
            <div className="hidden lg:flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl shadow p-6">
              <img src="/promo-left.jpg" alt="Promo Left" className="rounded-lg mb-4 w-full h-48 object-cover" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Special Offer</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-center">
                Get exclusive discounts on study materials and dorm essentials.
              </p>
              <Button className="bg-primary-500 hover:bg-primary-600 text-white w-full">Contact Us</Button>
            </div>
            ...
            <div>
              {isLoading ? (
                ...
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12" data-testid="featured-products">
            ...
            {/* Right Promo */}
            <div className="hidden lg:flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl shadow p-6">
              <img src="/promo-right.jpg" alt="Promo Right" className="rounded-lg mb-4 w-full h-48 object-cover" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Join the Community</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-center">
                Share your items and connect with buyers across the campus.
              </p>
              <Button className="bg-primary-500 hover:bg-primary-600 text-white w-full">Contact Us</Button>
            </div>
          </div>
